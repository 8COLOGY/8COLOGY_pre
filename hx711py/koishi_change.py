...
# json file name
key_name = '/opt/8cology/bin/cology-206480b62079.json'
...
​
    ...
    # print(container)
​
    if target_container in container:
              container_true = 1
              wks.update_acell(cell_number,container_true)
    else:
              container_false = 0               
              wks.update_acell(cell_number,container_false)        
​
              time.sleep(0.5)    
​
# do a bit of cleanup
